...
Rashi.addCommand({pattern: 'menu', fromMe: true, desc: 'it send bot menu'}, (async (message, match) => {
    ...
    r_text[0] = "https://www.linkpicture.com/en/q/20211014_083341.jpg";
...
if (config.AUTOBİO == 'false') auto_bio = ' ᴏғғ'
    ...
    await message.sendMessage(Buffer(rashi.data), MessageType.image, {mimetype: Mimetype.png, thumbnail: caption: `╭──────────────────╮
   ` + config.BOTPLK + `
╭──────────────────╯
│
│ ʜᴇʏ ᴜsᴇʀ ` + wish + `
